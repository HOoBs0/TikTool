export default function Policy() {
    return (
        <div className="policy my-15 md:my-30 mx-5 md:mx-50 text-left">
            <h1 className="text-4xl mb-4 font-bold text-orange-400">Privacy policy.</h1>
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to TikTooL.</p>
                </li>
                <li>
